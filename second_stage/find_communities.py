...
parser.add_argument( "term", type=str, default=sys.stdin, help = \
        "The term to cluster for.")

parser.add_argument( "min_points", type=int, default=sys.stdin, help = \
        "The minimum number of data points to allow.")

parser.add_argument( "min_correlation", type=float, default=sys.stdin, help = \
        "The minimum correlation to allow.")

parser.add_argument( "min_sensitivity", type=float, default=sys.stdin, help = \
        "The minimum sensitivity to allow.")

parser.add_argument( "max_sensitivity", type=float, default=sys.stdin, help = \
